...
class PlatformParameterTests(test_utils.GenericTestBase):
    ...
    def test_evaluate_matching_param_invalid_platform_type_returns_def(
        self
    ) -> None:
        parameter = parameter_domain.PlatformParameter.from_dict({
            'name': 'parameter_a',
    ...
    def test_evaluate_matching_param_missing_platform_type_returns_def(
        self
    ) -> None:
        parameter = parameter_domain.PlatformParameter.from_dict({
            'name': 'parameter_a',
    ...
    def test_validate_param_passes_without_exception(self) -> None:
        parameter = parameter_domain.PlatformParameter.from_dict({
            'name': 'parameter_a',
            'description': 'for test',
            'data_type': 'bool',
